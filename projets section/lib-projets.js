!(function () {
  ...
  function h(t = {}) {
    ...
    let n;
    return (
      void 0 !== e.types ? (n = e.types) : void 0 !== e.split && (n = e.split),
      void 0 !== n &&
  ...
  function G(t, e, n) {
    ...
    return (
      e.absolute &&
        ((u = { left: t.offsetLeft, top: t.offsetTop, width: t.offsetWidth }),
        (l = t.offsetWidth),
        (a = t.offsetHeight),
        ...
        const s = r.parentElement === t,
          {
            ...
            return { width: u, height: c, top: f + o - l, left: h + s - a };
          })(r, s, e, n);
   ...
   */ var tt,
    ...
    qe = function (t, e, n, i) {
      return (
        e.parent && Re(e),
        (e._start = be(
          (Wt(n) ? n : n || t !== et ? Je(t, n, e) : t._time) + e._delay
        )),
        (e._end = be(
    ...
    Ke = function (t, e, n, i) {
      ...
      return (
        ...
        (t._dur = s),
        (t._tDur = r ? (r < 0 ? 1e10 : be(s * (r + 1) + t._rDelay * r)) : s),
        o > 0 && !i ? Ve(t, (t._tTime = t._tDur * o)) : t.parent && Ne(t),
        n || ze(t.parent, t),
        t
      );
    },
        ...
        ? ((s = n.charAt(0)),
          ...
          "<" === s || ">" === s
            ...
            : ((s = parseFloat(n.charAt(r - 1) + n.substr(r + 1))),
              o && i && (s = (s / 100) * ($t(i) ? i[0] : i).totalDuration()),
    ...
    tn = function (t, e, n) {
      ...
      if ((s && (a.duration = e[1]), (a.parent = n), t)) {
        for (i = a, r = n; r && !("immediateRender" in i); )
          (i = r.vars.defaults || {}), (r = Vt(r.vars.inherit) && r.parent);
    ...
    yn = function (t) {
      var e = (t = (!t.name && t.default) || t).name,
        ...
        s = { targetTest: 0, get: 0, getSetter: oi, aliases: {}, register: 0 };
      if ((Dn(), t !== i)) {
        if (he[e]) return;
        ke(i, ke(Pe(t, r), s)),
    ...
    Tn = function (t, e, n) {
      var i,
        ...
        h,
        f,
        d = t ? (Wt(t) ? [t >> 16, (t >> 8) & wn, t & wn] : 0) : bn.black;
      if (!d) {
        if (("," === t.substr(-1) && (t = t.substr(0, t.length - 1)), bn[t]))
          d = bn[t];
        else if ("#" === t.charAt(0)) {
          if (
            (t.length < 6 &&
          ...
          if (((d = f = t.match(Ut)), e)) {
            if (~t.indexOf("="))
              return (d = t.match(Gt)), n && d.length < 4 && (d[3] = 1), d;
          } else
            (o = (+d[0] % 360) / 360),
              (a = +d[1] / 100),
              (i =
    ...
    Mn = function (t, e, n) {
      ...
      if (
        ...
        for (o = (r = t.replace(Sn, "1").split(Kt)).length - 1; c < o; c++)
          a +=
            r[c] +
            (~i.indexOf(c)
              ? l.shift() || u + "0,0,0,0)"
        ...
        wake: function () {
          st &&
            (!it &&
              ...
              (rt = nt.document || {}),
              (ee.gsap = yi),
              (nt.gsapVersions || (nt.gsapVersions = [])).push(yi.version),
              ie(ne || nt.GreenSockGlobals || (!nt.gsap && nt) || {}),
    ...
    Vn = (function () {
      ...
      return (
        ...
        (e.timeScale = function (t) {
          ...
          var e =
            this.parent && this._ts ? Fe(this.parent._time, this) : this._tTime;
          return (
            (this._rts = +t || 0),
        ...
        (e.startTime = function (t) {
          if (arguments.length) {
            ...
            return (
              e && (e._sort || !this.parent) && qe(e, this, t - this._delay),
              this
            );
          }
          return this._start;
          ...
          return new Promise(function (n) {
            var i = Xt(t) ? t : Ee,
              r = function () {
                var t = e.then;
                (e.then = null),
                  Xt(i) && (i = i(e)) && (i.then || i === e) && (e.then = t),
                  n(i),
                  (e.then = t);
              };
  ...
  var jn = (function (t) {
    ...
    return (
        ...
        if (
          ...
          if (
            ...
            if (
              ...
              if (
                ...
                (g = w ? 0 : v),
                (this._lock = 1),
                (this.render(g || (p ? 0 : be(o * a)), e, !v)._lock = 0),
                (this._tTime = _),
          ...
          if (
            ...
            this._initted ||
              ...
              (this._zTime = t),
              (g = 0)),
            !g && i && !e && (vn(this, "onStart"), this._tTime !== _))
          )
            return this;
          if (i >= g && t >= 0)
            for (r = this._first; r; ) {
          ...
          if (
            ...
            return (this._start = h), Ne(this), this.render(t, e, n);
          this._onUpdate && !e && vn(this, "onUpdate", !0),
            ((_ === m && this._tTime >= this.totalDuration()) || (!_ && g)) &&
      ...
      (n.addPause = function (t, e, n) {
        ...
        return (
          (i.data = "isPause"), (this._hasPause = 1), qe(this, i, Je(this, t))
        );
      }),
      (n.removePause = function (t) {
        var e = this._first;
        for (t = Je(this, t); e; )
          e._start === t && "isPause" === e.data && Re(e), (e = e._next);
      }),
            ...
            ke(
              {
                ...
                onStart: function () {
                  if ((i.pause(), !n)) {
                    ...
                    c._dur !== t && Ke(c, t, 0, 1).render(c._time, !0, !0),
                      (n = 1);
                  }
                  a && a.apply(c, l || []);
                },
      ...
      (n.tweenFromTo = function (t, e, n) {
        return this.tweenTo(e, ke({ startAt: { time: Je(this, t) } }, n));
      }),
      (n.recent = function () {
        return this._recent;
      }),
          ...
          for (i = s.parent; o; )
            (e = o._prev),
              ...
              (n = o._start) > a && s._sort && o._ts && !s._lock
                ? ((s._lock = 1), (qe(s, o, n - o._delay, 1)._lock = 0))
                : (a = n),
              n < 0 &&
                o._ts &&
                ((r -= n),
  ...
  var qn,
      ...
      var u,
        ...
        h =
          "get" !== n
            ...
            ? l
              ? t[
                  e.indexOf("set") || !Xt(t["get" + e.substr(3)])
                    ? e
                    : "get" + e.substr(3)
                ](l)
              : t[e]()
    ...
    Gn = function (t, e, n, i, r, s) {
      ...
      if (
          ...
          (o = new he[t]()).init(
            ...
            o.rawVars
              ...
              : (function (t, e, n, i, r) {
                  if (
                    (Xt(t) && (t = Zn(t, r, e, n, i)),
                    !Nt(t) || (t.style && t.nodeType) || $t(t) || Ht(t))
                  )
        ...
        ((n._pt = a = new gi(n._pt, r, t, 0, 1, o.render, o, 0, o.priority)),
        n !== at)
      )
        for (l = n._ptLookup[n._targets.indexOf(r)], u = o._props.length; u--; )
          l[o._props[u]] = a;
      return o;
    },
    Kn = function t(e, n) {
      ...
      if (
        ...
        for (
          e._pt = e._ptCache = 0, w = (k && Vt(w)) || (w && !k), r = 0;
          r < D.length;
          r++
        ) {
          if (
            ...
            c &&
              ...
              ((e._pt = o =
                new gi(e._pt, a, h.name, 0, 1, h.render, h, 0, h.priority)),
            ...
            for (s in i)
              he[s] && (h = Gn(s, i, e, d, a, A))
                ? h.priority && (l = 1)
                : (f[s] = o =
                    Un.call(e, a, s, "get", i[s], d, A, 0, m.stringFilter));
      ...
      if (
        ...
        if (
          ...
          if ($t(w))
            ...
            for (c in ((l = {}), w))
              "ease" === c || "easeEach" === c || Qn(c, w[c], l, w.easeEach);
            for (c in l)
              for (
    ...
    return (
        ...
        if (p) {
          if (
            ...
            if (
              ...
              i && !f && !e && (vn(this, "onStart"), this._tTime !== g))
            )
              return this;
            for (r = this._pt; r; ) r.r(u, r.d), (r = r._next);
            (c &&
              c.render(
                t < 0 ? t : !i && l ? -1e-8 : c._dur * c._ease(i / this._dur),
                e,
                n
              )) ||
              ...
              (g !== this._tDur && g) ||
                ...
                e ||
                  (t < 0 && !f) ||
                  (!g && !f) ||
                  (vn(this, g === d ? "onComplete" : "onReverseComplete", !0),
                  this._prom &&
          ...
          !(function (t, e, n, i) {
            ...
            if (
              ...
              t._startAt && e < 0 && t._startAt.render(e, !0, !0),
                ...
                c && t._repeat && !n && t.parent && vn(t, "onRepeat"),
                (e >= t._tDur || e < 0) &&
                  t.ratio === l &&
                  (l && Re(t, 1),
                  n ||
                    (vn(t, l ? "onComplete" : "onReverseComplete", !0),
                    t._prom && t._prom()));
      ...
      (n.resetTo = function (t, e, n, i) {
        ...
        return (
          ...
          (function (t, e, n, i, r, s, o) {
            ...
            if (!c)
              for (
                c = t._ptCache[e] = [], l = t._ptLookup, u = t._targets.length;
                u--;
                ...
                if (!a)
                  return (Hn = 1), (t.vars[e] = "+=0"), Kn(t, o), (Hn = 0), 1;
                c.push(a);
              }
            for (u = c.length; u--; )
              ((a = c[u]).s =
      ...
      (n.kill = function (t, e) {
        if ((void 0 === e && (e = "all"), !(t || (e && "all" !== e))))
          return (this._lazy = this._pt = 0), this.parent ? _n(this) : this;
        if (this.timeline) {
          var n = this.timeline.totalDuration();
          return (
            this.timeline.killTweensOf(t, e, qn && !0 !== qn.vars.overwrite)
              ._first || _n(this),
            this.parent &&
              n !== this.timeline.totalDuration() &&
              Ke(this, (this._dur * this.timeline._tDur) / n, 0, 1),
            this
          );
        }
        var i,
        ...
        for (
          ...
          if (~h.indexOf(c[u]))
            ...
            o))
              (l = r && r[a]) &&
                (("kill" in l.d && !0 !== l.d.kill(a)) || Le(this, l, "_pt"),
                delete r[a]),
                "all" !== s && (s[a] = 1);
  ...
  ke(ei.prototype, { _targets: [], _lazy: 0, _startAt: 0, _op: 0, _onInit: 0 }),
  ...
  var mi = {
    ...
    registerEffect: function (t) {
      ...
      (i || "").split(",").forEach(function (t) {
        return (
          t && !he[t] && !ee[t] && se(e + " effect requires " + t + " plugin.")
        );
      }),
        (fe[e] = function (t, e, i) {
          ...
          (!v && "%" !== c) || (!Ei[n] && !~n.indexOf("adius"))
            ? ((h[f ? "width" : "height"] = g + (m ? c : r)),
              ...
              (a = o._gsap) && v && a.width && f && a.time === Cn.time
                ? we((u / a.width) * g)
                : ((v || "%" === c) && (h.position = Ki(e, "position")),
                  o === e && (h.position = "static"),
                  o.appendChild(Oi),
                  (s = Oi[p]),
                  o.removeChild(Oi),
                  (h.position = "absolute"),
                  f && v && (((a = ve(o)).time = Cn.time), (a.width = o[p])),
      ...
      if (e.tween && e.tween._time === e.tween._dur) {
        ...
        if ("all" === a || !0 === a) (o.cssText = ""), (i = 1);
          ...
          for (r = (a = a.split(",")).length; --r > -1; )
            (n = a[r]),
              Ei[n] && ((i = 1), (n = "transformOrigin" === n ? Ui : $i)),
              rr(s, n);
        i &&
          (rr(s, $i),
          l &&
    ...
    _r = function (t, e, n, i, r, s) {
      ...
      n
        ? c !== dr &&
          ...
          (T = l))
        : ((x = (o = nr(t)).x + (~b[0].indexOf("%") ? (x / 100) * o.width : x)),
          (T =
    ...
    yr = function (t, e) {
      ...
      return (
        ...
        n.svg &&
          ...
          _r(t, S || X, !!S || n.originIsAbsolute, !1 !== n.smooth, m)),
        (p = n.xOrigin || 0),
        (g = n.yOrigin || 0),
        m !== dr &&
          ((w = m[0]),
          ...
          6 === m.length
            ...
            : ((L = m[6]),
              ...
              (u = (v = Di(L, P)) * ki),
              v &&
                ((S = O * (_ = Math.cos(-v)) + C * (y = Math.sin(-v))),
                (E = M * _ + D * y),
                (k = L * _ + P * y),
                (C = O * -y + C * _),
                (D = M * -y + D * _),
          ...
          n.svg &&
            ...
            (n.forceCSS = t.setAttribute("transform", "") || !gr(Ki(t, $i))),
        ...
        (n.zOrigin = parseFloat(X.split(" ")[2]) || 0) && (R[Ui] = wr(X)),
    ...
    Dr = function (t, e, n) {
      ...
      Ei))
        (s = c[r]) !== (o = i[r]) &&
          ...
          ((a = rn(s) !== (u = rn(o)) ? ar(n, r, s, u) : parseFloat(s)),
          (l = parseFloat(o)),
        ...
        for (h in (Ti || Ji(), e))
          if (
            ...
            if (
              ...
              "string" === u && ~o.indexOf("random(") && (o = pn(o)),
              c)
            )
              c(this, t, h, o, n) && (y = 1);
              ...
              if (
                (S && h in S
                  ? ((s =
                      "function" == typeof S[h] ? S[h].call(n, i, t, r) : S[h]),
                    Yt(s) && ~s.indexOf("random(") && (s = pn(s)),
                    rn(s + "") || (s += kt.units[h] || rn(lr(t, h)) || ""),
                    "=" === (s + "").charAt(1) && (s = lr(t, h)))
                  : (s = lr(t, h)),
                (l = parseFloat(s)),
                (p = "string" === u && "=" === o.charAt(1) && o.substr(0, 2)) &&
                  (o = o.substr(2)),
                (a = parseFloat(o)),
                h in Li &&
                  ("autoAlpha" === h &&
                ...
                if (
                  ...
                  (this._pt = new gi(
                    ...
                    "scaleY",
                    v.scaleY,
                    (p ? xe(v.scaleY, p + a) : a) - v.scaleY || 0
                  )),
                    O.push("scaleY", h),
                    (h += "X");
                else {
                    ...
                    (b = void 0),
                      ...
                      v.svg
                        ...
                        : ((d = parseFloat(o.split(" ")[2]) || 0) !==
                            v.zOrigin && sr(this, v, "zOrigin", v.zOrigin, d),
              ...
              if (
                g ||
                ((a || 0 === a) && (l || 0 === l) && !Ii.test(o) && h in M)
              )
                a || (a = 0),
                  (f = (s + "").substr((l + "").length)) !==
                    (d = rn(o) || (h in kt.units ? kt.units[h] : f)) &&
                    (l = ar(t, h, s, d)),
                  (this._pt = new gi(
                    this._pt,
                    g ? v : M,
                  ...
                  (this._pt.u = d || 0),
                  f !== d && "%" !== d && ((this._pt.b = s), (this._pt.r = Bi));
    ...
    initEvents() {
      window.addEventListener("resize", () => {
        this.SplitTypeInstance.split(),
          ...
          this.isVisible ||
            Rr.set(this.SplitTypeInstance.lines, { yPercent: -105 });
      });
    }
    constructor(t) {
      a(this, "DOM", { el: null }),
   ...
   */ var qr,
    ...
    ys = {
      ...
      sc: vs(function (t) {
        return arguments.length
          ? $r.scrollTo(_s.sc(), t)
          : $r.pageYOffset || Ur.scrollTop || Gr.scrollTop || Kr.scrollTop || 0;
      }),
    },
    ws = function (t) {
      return (
  ...
  var Es = (function () {
    ...
    return (
      (t.prototype.init = function (t) {
        Hr || Ss(qr) || console.warn("Please gsap.registerPlugin(Observer)"),
          Jr || Ms();
        var e = t.tolerance,
          n = t.dragMinimum,
          i = t.type,
        ...
        (this.target = r = ws(r) || Gr),
          ...
          (o = !1 !== o),
          s || (s = parseFloat($r.getComputedStyle(Kr).lineHeight) || 22);
        var V,
          j,
          q,
          H,
          ...
          dt = function (t, e) {
            "y" !== G && ((ot[2] += t), K._vx.update(t, !0)),
              ...
              F &&
                !G &&
                ((K.axis = G = Math.abs(t) > Math.abs(e) ? "x" : "y"),
                (U = !0)),
              o ? V || (V = requestAnimationFrame(ht)) : ht();
          },
          pt = function (t) {
        ...
        (j = K._dc =
          ...
          (K.enable = function (t) {
            return (
              K.isEnabled ||
                ...
                i.indexOf("scroll") >= 0 && fs(rt ? st : r, "scroll", yt, a, X),
                i.indexOf("wheel") >= 0 && fs(r, "wheel", wt, a, X),
          ...
          (K.disable = function () {
            K.isEnabled &&
              ...
              K.isPressed &&
                (K._vx.reset(), K._vy.reset(), ds(P ? r : st, ns[1], pt, !0)),
  ...
  var ks,
    ...
    wo = function (t) {
      return (
        ...
        (yo(t)
          ? function () {
              return (
                (Da.width = Ds.innerWidth), (Da.height = Ds.innerHeight), Da
              );
            }
          : function () {
              return Vo(t);
    ...
    ea = function (t, e, n, i, r, s, o, a) {
      ...
      return (
        ...
        (g || a || !p) &&
          (y += (i === ys ? Io : Lo) + ":" + (s + parseFloat(h)) + "px;"),
        o &&
          (y +=
    ...
    la = function () {
      os.cache++,
        !Ws &&
          ...
          (!Qs ||
            Js !== Ds.innerWidth ||
            Math.abs(Ds.innerHeight - Zs) > 0.25 * Ds.innerHeight) &&
          Rs.restart(!0);
    },
    ua = {},
    ca = [],
      ...
      if (ro !== n || ao) {
        for (va(); r < ha.length; r += 4)
          (e = Ds.matchMedia(ha[r]).matches) !== ha[r + 3] &&
            ((ha[r + 3] = e),
            e ? i.push(r) : va(1, ha[r]) || (Oo(ha[r + 2]) && ha[r + 2]()));
    ...
    ma = function (t) {
      for (var e = 0; e < ga.length; e += 5)
        (t && ga[e + 4] !== t) ||
          ...
          ga[e].getBBox && ga[e].setAttribute("transform", ga[e + 2] || ""),
          (ga[e + 3].uncache = 1));
    },
    va = function (t, e) {
      var n;
      for (Vs = 0; Vs < ia.length; Vs++)
        (n = ia[Vs]), (e && n.media !== e) || (t ? n.kill(1) : n.revert());
      e && ma(e), e || pa("revert");
    },
    _a = function () {
      return (
    ...
    Ta = function () {
      if (!so) {
        ...
        if (
          ...
          (ba = i),
          n &&
            (co && !Fs && e - co > 200 && ((co = 0), pa("scrollEnd")),
            (Ys = uo),
            (uo = e)),
          xa < 0)
        ) {
    ...
    ka = function (t) {
      if (t) {
        var e,
          ...
          r = t.length,
          s = 0;
        for ((t.t._gsap || ks.core.getCache(t.t)).uncache = 1; s < r; s += 2)
          (n = t[s + 1]),
            (e = t[s]),
            n
              ? (i[e] = n)
              : i[e] && i.removeProperty(e.replace(Ea, "-$1").toLowerCase());
      }
    },
    Ca = function (t) {
    ...
    Pa = function (t, e, n, i, r, s, o, a, l, u, c, h, f) {
      Oo(t) && (t = t(a)),
        To(t) &&
          "max" === t.substr(0, 3) &&
          (t = h + ("=" === t.charAt(4) ? ta("0" + t.substr(3), n) : 0));
      var d,
        p,
        g,
        m = f ? f.time() : 0;
      ...
      if (s) {
        ...
        (d = "scroll" + i.d2),
          na(
            ...
            i,
            (T && x > 20) ||
              (!T && (c ? Math.max(Is[d], As[d]) : s.parentNode[d]) <= x + 1)
          ),
          c &&
            ((l = Vo(o)),
            c && (s.style[i.op.p] = l[i.op.p] - i.op.m - s._offset + Wo));
      }
      return (
        f &&
          g &&
    ...
    Ra = (function () {
      ...
      return (
        (t.prototype.init = function (e, n) {
          if (
            ...
            var i,
              ...
              V,
              j = (e = No(
                To(e) || Mo(e) || e.nodeType ? { trigger: e } : e,
                Zo
              )),
              q = j.onUpdate,
              H = j.toggleClass,
            ...
            if (
              ...
              "refreshPriority" in e &&
                (($s = 1), -9999 === e.refreshPriority && (oo = bt)),
              ...
              st &&
                ...
                "scrollBehavior" in Is.style &&
                  ks.set(gt ? [Is, As] : dt, { scrollBehavior: "auto" }),
                (s = Oo(st.snapTo)
                  ? st.snapTo
                  : "labels" === st.snapTo
                  ? (function (t) {
                ...
                (R = ks
                  .delayedCall(st.delay || I / 2 || 0.1, function () {
                    var t = Et(),
                      e = lo() - St < 500,
                      r = i.tween;
                    if (
                      ...
                      var o = (t - l) / g,
                        ...
                        h = ks.utils.clamp(-o, 1 - o, (Po(c / 2) * c) / 0.185),
              ...
              $ && (ra[$] = bt),
              (W =
                (Q = bt.trigger = ws(Q || Z)) && Q._gsap && Q._gsap.stRevert) &&
                (W = W(bt)),
              (Z = !0 === Z ? Q : ws(Z)),
              ...
              Z &&
                (!1 === J ||
                  J === Yo ||
                  (J = !(!J && "flex" === Fo(Z.parentNode).display) && Bo),
                (bt.pin = Z),
                ...
                (r = ks.core.getCache(Z)).spacer
                  ...
                  : (at &&
                    ...
                    (r.spacer = y = at || Ps.createElement("div")),
              ...
              (c = this.markerStart = ea("start", $, kt, ht, p, w, 0, lt)),
                (h = this.markerEnd = ea("end", $, kt, ht, p, w, 0, lt)),
                lt && (X = ks.quickSetter([c, h], ht.a, Wo)),
                mt ||
                  (as.length && !0 === cs(dt, "fixedMarkers")) ||
            ...
            (bt.previous = function () {
              ...
              (bt.revert = function (t) {
                ...
                e !== bt.isReverted &&
                  (e &&
                    (bt.scroll.rec || !Ws || !so || (bt.scroll.rec = Et()),
                  ...
                  if (Z && r && co) Uo(t, "scrollEnd", da);
                    ...
                    for (
                      var p,
                        ...
                        q =
                          e.start ||
                          (0 !== e.start && Q ? (Z ? "0 0" : "0 100%") : 0),
                        H = (bt.pinnedContainer =
                          e.pinnedContainer && ws(e.pinnedContainer)),
                        $ = (Q && Math.max(0, ia.indexOf(bt))) || 0,
                        U = $;
                      U--;

                    )
                      (k = ia[U]).end || k.refresh(0, 1) || (Ws = 1),
                        !(C = k.pin) ||
                          (C !== Q && C !== Z) ||
                          k.isReverted ||
                          (I || (I = []), I.unshift(k), k.revert()),
                        k !== ia[U] && ($--, U--);
                    for (
                      Oo(q) && (q = q(bt)),
                        l =
                          Pa(q, Q, L, ht, Et(), c, f, bt, X, wt, mt, W, lt) ||
                          (Z ? -0.001 : 0),
                        Oo(V) && (V = V(bt)),
                        To(V) &&
                          !V.indexOf("+=") &&
                    ...
                    if (
                      ...
                      (p = Fo(Z)),
                        ...
                        !W &&
                          u > 1 &&
                          ((gt ? Is : dt).style["overflow-" + ht.a] = "scroll"),
                        Sa(Z, y, p),
                        (_ = Ca(Z)),
                        (w = Vo(Z, !0)),
                        (D = mt && bs(dt, M ? _s : ys)()),
                        J &&
                          (((S = [J + ht.os2, g + N + Wo]).t = y),
                          (U = J === Bo ? jo(Z, ht) + g + N : 0) &&
                            S.push(ht.d, U + Wo),
                          ka(S),
                          mt && Et(B)),
                        mt &&
                          (((E = {
                            ...
                            Math.ceil(w.width) + Wo),
                          (E.height = E.maxHeight = Math.ceil(w.height) + Wo),
                          (E.margin =
                            E.marginTop =
                            E.marginRight =
                            E.marginBottom =
                ...
                if (!lt || r || t) {
                  ...
                  if (
                    (e &&
                      ((a = o),
                      (o = lt ? Et() : b),
                      st && ((P = D), (D = n && !ft ? n.totalProgress() : C))),
                    et &&
                      !C &&
                      Z &&
                      !Ws &&
                    ...
                    if (
                      ...
                      d &&
                        !Ws &&
                        ((c = C && !I ? 0 : 1 === C ? 1 : 1 === I ? 2 : 3),
                        ft &&
                          ((h =
                            (!p && "none" !== _t[c + 1] && _t[c + 1]) || _t[c]),
                          (w =
                            n &&
                      ...
                      ft ||
                        (!A || Ws || ao
                          ? n && n.totalProgress(C, !!Ws)
                          : ((lt || (oo && oo !== bt)) &&
                              A.render(A._dp._time - A._start),
                            A.resetTo
                              ? A.resetTo(
                                  "totalProgress",
                                  C,
                    ...
                    st && !i.tween && !Ws && !ao && R.restart(!0),
                      H &&
                        (p || (rt && C && (C < 1 || !eo))) &&
                        zs(H.targets).forEach(function (t) {
                      ...
                      d && !Ws
                        ? (ft &&
                          ...
                          (!p && eo) ||
                            ...
                            p || (vt[(c = 1 === C ? 1 : 3)] && Do(bt, vt[c]))),
                          ut &&
                            !s &&
                            Math.abs(bt.getVelocity()) > (Mo(ut) ? ut : 2500) &&
                            (Co(bt.callbackAnimation),
                            A ? A.progress(1) : Co(n, !C, 1)))
                        : ft && q && !Ws && q(bt);
                  }
                  if (k) {
                    var B = lt
              ...
              (bt.disable = function (e, n) {
                if (
                  ...
                  R && (R.pause(), i.tween && i.tween.kill() && (i.tween = 0)),
                  !gt)
                ) {
          ...
          if (
            ...
            for (
              i.borderTopStyle = "solid",
                ...
                Uo(Is, "touchstart", go),
                $o(Uo, Ps, "pointerdown,touchstart,mousedown", fo),
        ...
        (t.config = function (e) {
          ...
          (n && clearInterval(Xs)) || ((Xs = n) && setInterval(sa, n)),
        ...
        (t.scrollerProxy = function (t, e) {
          var n = ws(t),
            ...
            r = yo(n);
          ~i && os.splice(i, r ? 6 : 2),
            e && (r ? as.unshift(Ds, e, Is, e, As, e) : as.unshift(n, e));
        }),
  ...
  var za,
    ...
    ja = function (t) {
      ...
      var e,
        ...
        g =
          to &&
          ((t.content && ws(t.content)) || (p && p.get() && p.get().content())),
        m = bs(d, ys),
        v = bs(d, _s),
        _ = 1,
        y =
      ...
      return (
        ...
        (t.onPress = function () {
          var t = _;
          (_ = mo(((Ds.visualViewport && Ds.visualViewport.scale) || 1) / y)),
            s.pause(),
            t !== _ && Ya(d, _ > 1.01 || (!c && "x")),
            (i = !1),
            (o = v()),
          ...
          function (t, e) {
            if (
              ...
              var i,
                ...
                o = b();
              c &&
                ((r = (i = v()) + (0.05 * o * -t.velocityX) / 0.227),
                (o *= Ba(v, i, r, bo(d, _s))),
                (s.vars.scrollX = O(r))),
  ...
  (Ra.sort = function (t) {
    ...
    (Ra.normalizeScroll = function (t) {
      ...
      return (
        Ks && Ks.target === e.target && Ks.kill(), yo(e.target) && (Ks = e), e
      );
    }),
    (Ra.core = {
      _getVelocityProp: xs,
   ...
   */ var qa,
    ...
    sl = function () {
      return (
        Ha.pageYOffset || qa.scrollTop || $a.scrollTop || Ua.scrollTop || 0
      );
    },
    ol = function () {
      return (
        Ha.pageXOffset || qa.scrollLeft || $a.scrollLeft || Ua.scrollLeft || 0
      );
    },
    al = function (t) {
      return (
    ...
    hl = function (t, e) {
      ...
      if (t === Ha) return t;
      if (
        (c.length || c.push(ul(t, 1), ul(t, 2), ul(t, 3)), (n = l ? Ka : Ga), l)
      )
        u
          ...
          ? ((r = t.getBBox()),
            (i = (i = t.transform ? t.transform.baseVal : {}).numberOfItems
              ? i.numberOfItems > 1
                ? (function (t) {
                    for (var e = new dl(), n = 0; n < t.numberOfItems; n++)
      ...
      return (
        ...
        (e.apply = function (t, e) {
          ...
          var n = t.x,
            ...
            u = this.f;
          return (
            (e.x = n * r + i * o + l || 0), (e.y = n * s + i * a + u || 0), e
          );
        }),
        t
      );
  ...
  var gl,
    ...
    jl = function (t, e) {
      for (
        var n, i, r = t.element.style, s = (t.css = t.css || []), o = e.length;
        o--;
    ...
    Ul = function (t, e, n) {
      ...
      return (
        (i = eu(i, t, !0)), (t.x = wl(i.x, 0.01)), (t.y = wl(i.y, 0.01)), o
      );
    },
    Gl = function (t, e) {
      return (
    ...
    Kl = function (t) {
      return Vl(t, !0).forEach(function (t) {
        return (
          (t.a.isVisible || t.b.isVisible) && Ul(t.sd < 0 ? t.b : t.a, t.b, 1)
        );
      });
    },
    Ql = function (t, e, n, i) {
      return t instanceof fu
        ...
        : new fu(
            "string" == typeof t ? Il(t) || console.warn(t + " not found") : t,
            e,
            n
          );
    },
      ...
      return (
        ...
        P || !g
          ...
          ? (p.renderTransform(1, p),
            ...
            (v += l.y - a.y))
          : ((c.e = c.f = 0),
            (m += (l = c.apply({ x: k - t.matrix.e, y: C - t.matrix.f })).x),
            (v += l.y)),
        (m = wl(m, 0.02)),
        (v = wl(v, 0.02)),
        !s || s instanceof fu
    ...
    ou = function (t) {
      if (t !== bl) {
        ...
        if (t && (n || i)) {
          for (; r--; ) ru[r] = e[su[r]];
          n && ((e.width = yl.clientWidth + "px"), (e.overflowY = "hidden")),
            i &&
              ((e.height = yl.clientHeight + "px"), (e.overflowX = "hidden")),
            (bl = t);
        } else if (bl) {
          for (; r--; )
            ru[r] ? (e[su[r]] = ru[r]) : e.removeProperty(Yl(su[r]));
          bl = t;
        }
      }
    },
    au = function (t, e, n, i) {
      ...
      (g = function () {
        for (Vl(q), ou(!0), a = 0; a < q.length; a++)
          (u = q[a]),
            ...
            !Y || m.isDifferent(v) || u.entering
              ? ((l = u.t),
                A && !(u.sd < 0) && a && (m.matrix = pl(l, !1, !1, !0)),
                u.sd || (v.isVisible && m.isVisible)
                  ? (u.sd < 0
                      ...
                      : u.sd > 0 &&
                        R &&
                        (l.style.opacity = G ? m.opacity - v.opacity : "0"),
                    eu(m, v, L, X))
                  : v.isVisible !== m.isVisible &&
                    (v.isVisible
                      ? m.isVisible ||
                        ...
                        q.splice(a--, 1),
                        T && A && eu(m, v, L, X))
                      : (m.isVisible && V.push(m), q.splice(a--, 1))),
                L ||
        ...
        if (
          ...
          for (s in ((N = Xl(W, zl)),
          "scale" in M && ((M.scaleX = M.scaleY = M.scale), delete M.scale),
          M))
            ((r = Xl(M[s], Bl))[s] = W[s]),
              !("duration" in r) &&
                "duration" in W &&
    ...
    hu = (function () {
      ...
      return (
        ...
        (e.add = function (t) {
          for (
            var e, n, i, r = t.targets.length, s = this.idLookup, o = this.alt;
            r--;
            ...
            (n.element === i.element ||
              ...
              : (this.targets.push(t.targets[r]), this.elementStates.push(n));
          return (
        ...
        (e.compare = function (t) {
          ...
          for (i in u)
            (s = m[i]),
              ...
              o
                ? ((l =
                    n.isVisible || (!o.isVisible && r === n.element) ? n : o),
                  (a =
                    !s || e.isVisible || s.isVisible || l.element !== s.element
                      ? e
                      : s).isVisible &&
                  l.isVisible &&
                  a.element !== l.element
                  ...
                  s && y(s, o.element === s.element ? o : n, s.element))
                : (n ? (n.isDifferent(e) ? _(e, n, r) : h.push(r)) : d.push(r),
                  s && y(s, n, s.element));
          for (i in c)
            u[i] || (p.push(c[i].element), v[i] && p.push(v[i].element));
          return { changed: f, unchanged: h, enter: d, leave: p };
        }),
        (e.recordInlineStyles = function () {
          for (
            var t = Cl[this.props] || Al, e = this.elementStates.length;
            e--;
          ...
          (r.getProp = o),
            ...
            (r.id =
              ((i = (n = s).getAttribute("data-flip-id")) ||
                n.setAttribute("data-flip-id", (i = "auto-" + xl++)),
              i)),
            (r.matrix = c),
            (r.cache = a),
            (r.bounds = l),
            ...
            t &&
              (function (t, e) {
                for (
                  var n = ml.getProperty(t.element, null, "native"),
                    i = (t.props = {}),
                    r = e.length;
                  r--;
            ...
            (r.ctm =
              ...
              cl(s).inverse()),
            (r.simple =
              e || (1 === Ll(c.a) && !Ll(c.b) && !Ll(c.c) && 1 === Ll(c.d))),
            (r.uncache = 0);
        }),
        t
      );
    ...
    pu = (function () {
      ...
      return (
        (e.add = function (t) {
          ...
          return e.length
            ? e[0]
            : ((e = new du("function" == typeof t ? { animate: t } : t, this)),
              this.actions.push(e),
              e);
        }),
        (e.remove = function (t) {
            ...
            vl = this,
              ...
              this.actions.forEach(function (t) {
                ...
                s &&
                  ...
                  (n = e.compare(gu.getState(s))).enter.length &&
                    i &&
                    i(n.enter),
            ...
            this.actions.forEach(function (n) {
              if (n.vars.loadState) {
                var i,
                  r = function r(s) {
                    s && (n.targets = s),
                      ~(i = e.indexOf(r)) && (e.splice(i, 1), e.length || t());
                  };
  ...
  const Ou = (t) => {
      ...
      const i = Rr.timeline({
        ...
        onStart: () => {
          bu.stop(),
            ...
            Rr.set([t.content.DOM.titleInner, t.content.DOM.metaInner], {
              yPercent: -101,
              opacity: 0,
            }),
      ...
      i.add(() => {
        ...
        t.content.DOM.el.appendChild(t.DOM.image),
          gu.from(e, { duration: mu.duration, ease: mu.ease, absolute: !0 });
      }, "start")
        .to(
          t.DOM.titleInner,
        ...
        Tu ||
          ...
          (() => {
            ...
            Rr.timeline({
              ...
              .to(t.DOM.description, { yPercent: 0, opacity: 1 }, "preview")
              .to(
                t.DOM.imageInner,
        ...
        for (const t of yu)
          Rr.set(t.DOM.imageInner, { transformOrigin: "50% 0%" }),
            (t.scrollTimeline = Rr.timeline({
              ...
              .addLabel("start", 0)
              .to(t.DOM.title, { ease: "none", yPercent: -100 }, "start")
              .to(t.DOM.imageInner, { ease: "none", scaleY: 1.8 }, "start"));
      })(),
      Mu();
  });
})();
